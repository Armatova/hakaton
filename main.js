...
//   for (let a = 0; a < i.length; i++) {
//     console.log(`${i[a]}: ${i[a + 1]}`);
//   }
// }
...
//?ANSWER
// let word = [2, "hello", true, "world", 5, "js"];
// let removeElement = (arr, element) => {
...
//?ANSWER
// let arr = ["Thailand", "USA", "Russia", "Ukraine", "Kyrgyzstan", "Utah"];
// let result = arr.filter((b) => b.length > 5);
// console.log(result);
